...
async def get_all_channels_from_site(page):
    print(">>> [1/3] Поиск списка всех каналов...", flush=True)
    try:
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # Обязательно headless=True для GitHub Actions
        ...
        if results:
            ...
            with open(filename, "w", encoding="utf-8") as f:
                ...
                for n, l in results:
                    ...
                    # ИСПРАВЛЕННЫЙ ФОРМАТ: добавлен / после домена и & перед User-Agent
        ...
        # Закрываем браузер без ошибок отступа
        await browser.close()
